...
def load_costs(tech_costs, config, max_hours, Nyears=1.0):
    ...
    costs.at["OCGT", "fuel"] = costs.at["OCGT", "fuel"] 
    costs.at["CCGT", "fuel"] = costs.at["CCGT", "fuel"]

    costs["marginal_cost"] = costs["VOM"] + costs["fuel"] / costs["efficiency"]

    costs = costs.rename(columns={"CO2 intensity": "co2_emissions"})

    costs.at["OCGT", "co2_emissions"] = costs.at["OCGT", "co2_emissions"]
    costs.at["CCGT", "co2_emissions"] = costs.at["CCGT", "co2_emissions"]
...
def attach_conventional_generators(
    ...
    if fuel_price is not None:
        fuel_price = fuel_price.assign(
            OCGT=fuel_price["OCGT"], CCGT=fuel_price["CCGT"]
        ).drop("gas", axis=1)
